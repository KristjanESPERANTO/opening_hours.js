...
2.  The maintainer updates holiday data and commits any changes:
    ...
    - **Public holidays** (if `submodules/date-holidays` has new upstream commits): `node scripts/sync_holidays_from_date_holidays.js` — regenerates `src/holidays/<cc>.yaml` files
